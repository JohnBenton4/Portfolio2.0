...
export default function DateApp() {
    useEffect(() => {
      document.title = "John Benton - DateApp";
      document.body.style.backgroundColor = "rgb(0,0,0)";
    }, []);
    return (
      <>
        {/* <Sidebar2 /> */}
        <div className="container-dateApp">
          <section className="greeting">
            <div className="dateApp-title">
              <h1 style= {{color: 'rgb(236, 235, 228)'}}>Hello</h1>
            </div>
            <br></br>
            <section className="dateApp-info">
...
//                   src="react-2.jpeg"
//                   alt="react 2 image"
//                   className="react-2-img"
//                 />
//                 <img
//                   src="react-3.jpeg"
//                   alt="react 3 image"
//                   className="react-3-img"
//                 />
//               </li>
